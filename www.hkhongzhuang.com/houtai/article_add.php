...
else if($dopost=='save')
{
   ...
   /* 百度推送 同时提交PC和移动端*/
    if($push==1) {
            ...
            //提交数据链接/*
            $api_pc = 'http://data.zz.baidu.com/urls?site=https://www.hkhongzhuang.com&token=Gbdb10GHA8NxrioW';
            $api_m = 'http://data.zz.baidu.com/urls?site=https://m.hkhongzhuang.com&token=Gbdb10GHA8NxrioW';
            $ch_pc = curl_init();
            $ch_m = curl_init();
            $options_pc =  array(
                CURLOPT_URL => $api_pc,
