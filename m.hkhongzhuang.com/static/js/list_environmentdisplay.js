function reHeight_Fn(){
    ...
    var htmlFont=$("html").css('font-size').split("px")[0];//获取页面字体大小
    var hg=($(".list_chain_con_Main").height())/htmlFont;
   $(".list_chain_con_Main_C").height((hg-5.29067)+"rem");
}
function more_Fn(){
...
function close_btn(){
  $(document).on("click",".article_chain_sw",function(){
