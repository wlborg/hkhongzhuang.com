...
else if($dopost=='save')
{
    ...
    if($push==1){
        $url_pc='https://www.hkhongzhuang.com/'.$artUrl;
            $url_m='https://m.hkhongzhuang.com/'.$artUrl;
            //提交数据链接/*
            $api_pc = 'http://data.zz.baidu.com/update?site=https://www.hkhongzhuang.com&token=Gbdb10GHA8NxrioW';
            $api_m = 'http://data.zz.baidu.com/update?site=https://m.hkhongzhuang.com&token=Gbdb10GHA8NxrioW';
            $ch_pc = curl_init();
            $ch_m = curl_init();
            $options_pc =  array(
                CURLOPT_URL => $api_pc,
    ...
    <a href=''><u>百度提交，PC版:".$result_pc."手机版:".$result_m."</u></a>
    &nbsp;&nbsp;
    $backurl
    ";
    $wintitle = "成功更改文章！";
